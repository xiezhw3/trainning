...
(function() {
    ...
    var template = 
        ...
        + '        <i class="fa fa-home home-icon" ng-if="$first"></i>'
        + '        <a ui-sref="{{ crumb.route }}" ng-if="!$last">'
        + '            {{ crumb.displayName }}&nbsp;</a>'
        + '        <span ng-show="$last">{{ crumb.displayName }}</span>'
        + '    </li>'
        + '</ol>'
        ;
    var templateUrl = 'views/galaxy/common/breadcrumbs.html';
    ...
    module.directive('uiBreadcrumbs', ['$interpolate', '$state', '$filter', function($interpolate, $state, $filter) {
            return {
                restrict: 'E',
                        ...
                        while(currentState && currentState.name !== '') {
                            ...
                            if (workingState) {
                                ...
                                if (displayName !== false && !stateAlreadyInBreadcrumbs(workingState, breadcrumbs)) {
                                    breadcrumbs.push({
                                        displayName: $filter('translate')(displayName),
