  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function link(scope, element, attrs, $select, transcludeFn) {
        ...
        var limitItems = attrs.limit; // by qinpeng
        ...
        choices.attr('ng-repeat', $select.parserResult.repeatExpression(groupByExp, limitItems))
  ...
  ctrl.parseRepeatAttr = function(repeatAttr, groupByExp, groupFilterExp) {
    function updateGroups(items) {
      ...
      angular.forEach(items, function(item) {
        ...
        //by qinpeng
        var groupName = angular.isFunction(groupFn) ? groupFn(item) : item[groupByExp];
...
uis.service('uisRepeatParser', ['uiSelectMinErr','$parse', function(uiSelectMinErr, $parse) {
  ...
  self.parse = function(expression) {
    ...
    return {
      ...
      repeatExpression: function (grouped, limit) {
